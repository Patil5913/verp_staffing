...
#         values_dict["from_date"] = filters["from_date"]
    
#     if filters.get("to_date"):
#         conditions.append("l.creation <= %(to_date)s")
#         values_dict["to_date"] = filters["to_date"]
    
#     if filters.get("visa_status"):
#         conditions.append("l.visa_status = %(visa_status)s")
#         values_dict["visa_status"] = filters["visa_status"]
...
#         # Use named placeholders for employees too
...
#     data = frappe.db.sql(query, values_dict, as_dict=True)
#     return data
