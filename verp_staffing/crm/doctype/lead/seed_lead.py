...
class TestLoad(FrappeTestCase):
    ...
    def test_lead_insert_performance(self):

        print(
            f"\n[PERF TEST] Inserting "
            f"{self.TOTAL_RECORDS:,} leads "
            f"(will rollback)...\n"
        )
        ...
        print("\n" + "=" * 55)
        print("         LEAD SEED PERFORMANCE SUMMARY")
        print("=" * 55)
