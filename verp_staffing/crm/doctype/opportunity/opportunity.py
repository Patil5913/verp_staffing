...
#         # Skip if document already has a name (update case)
...
#         # Find a unique name using direct DB query to avoid race conditions
#         candidate = base_name
#         counter = 0

#         while frappe.db.exists("Opportunity", candidate):
#             counter += 1
...
#     def validate(self):
#         # your existing validate code if any
#         pass

#     def on_submit(self):
#         # your existing on_submit code if any
#         pass
